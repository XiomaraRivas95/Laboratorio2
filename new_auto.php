...
if (isset($_POST['btn-insert'])) {
    ...
    if ($crud->insert($matricula, $marca, $modelo, $color, $precio)) {
        $msg = "¡Registro almacenado con éxito!";
        $type = "success";
    } else {
        $msg = "¡Ocurrió un error al intentar guardar el registro!";
        $type = "danger";
    }
}
?>
            ...
            <div class="col-6 p-4 bg-white shadow-lg rounded">
                ...
                <form method="post">
                    ...
                    <div class="mt-3">
                        ...
                        <button class="btn btn-primary" name="btn-insert" type="submit">Guardar</button>
                    </div>
                </form>
            </div>
